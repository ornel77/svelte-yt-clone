...
<div class="flex my-5 items-center justify-between">
    <div class="flex items-center gap-5">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="font-medium capitalize">Jack</p>
                <p class="text-gray-700 text-xs">1000 subs</p>
            </div>
            <button class="bg-black text-white text-sm font-medium rounded-full py-2 px-4">Subscribe</button>
        </div>
        <div class="flex gap-3 items-center">
            ...
            <button class="hover:bg-gray-200 rounded-full bg-gray-100 py-2 px-4 flex items-center gap-2">
                <img src="/icons/shareIcon.svg" alt="">
                <span class="text-sm font-medium">Share</span>
            </button>
            <button class="hover:bg-gray-200 rounded-full bg-gray-100 p-2 flex items-center gap-2">
